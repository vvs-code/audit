...
Также вверху страницы отображается ссылка на личный кабинет аудитора, в котором можно изменить личные данные или сменить пароль, а также кнопка выхода из аккаунта.
